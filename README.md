...
### Option 1: Use with Local Images
1. Download all files from this repository
2. Place your Pokemon images (1.png through 151.png) in the same folder as index.html
3. Open index.html in your web browser

### Option 2: GitHub Pages (Online)
1. Fork this repository
2. Add your Pokemon images (1.png through 151.png) to the repository
...
```
noras-pokedex/
├── index.html          # Main Pokedex application
├── README.md           # This file
├── 1.png              # Bulbasaur
├── 2.png              # Ivysaur
├── ...
...
Created for Nora's Pokemon collection tracking.
